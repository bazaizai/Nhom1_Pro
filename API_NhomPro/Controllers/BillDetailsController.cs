    ...
    public class BillDetailsController : ControllerBase
    {
        ...
        public string Post(Guid idBill, Guid idProduct, int sl, int trangthai)
        {
            ...
            if (b != null)
            {
                ...
                //var a = new BillDetail() { Id =b.Id, IdBill = idBill, IdProductDetail = idProduct, DonGia = c.GiaBan, SoLuong = b.SoLuong, TrangThai = trangthai };
                //BillRepo.RemoveItem(b);
                //return BillRepo.AddItem(a);
